...
import type { SkillPathResponse, Lesson, Module } from "@/lib/types";
          ...
          <div className="space-y-2">
            {mod.lessons?.map((lesson: Lesson, lessonIdx: number) => (
              <div
                ...
                className="group flex items-center justify-between rounded-lg border border-slate-800/80 bg-slate-950/60 p-3 text-sm text-slate-200 cursor-pointer transition-all hover:border-indigo-500/50 hover:bg-slate-800/50 hover:text-white"
              >
